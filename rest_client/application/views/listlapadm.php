            ...
            <thead class="thead-dark">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-success" href="<?php echo base_url('index.php/lapadm/d_laporan/'). $l->no_lap ?>"><i class="fa fa file"></i>Download</a>
                    <a class="btn btn-danger" href="<?php echo base_url('index.php/lapadm/delete/'). $l->no_lap ?>"><i class="fa fa file"></i>Delete</a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
