    ...
    <img src="<?php echo base_url(); ?>assets/img/logoo.jpg" alt="logoBrand" id="logoBrand" width="70" height="70">
      <ul class="navbar-nav mr-auto">      
        <li class="nav-item active">
          <h1 class="nav-link" >Tambah Data Dosen</h1>
        </li>
      </ul>
...
<br>
 <section>
  <form class="col-md-3" method="post" action="<?php echo base_url('index.php/dosen/create') ?>">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="nmdospem" placeholder="Nama Dosen Pembimbing" required>
    </div>
