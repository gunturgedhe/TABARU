...
<br>
<section>
<form class="col-md-3" method="post" action="<?php echo base_url('index.php/mahasiswa/edit') ?>">
    <div class="form-group">
      <label>Nomor Induk Mahasiswa</label>
      <input type="text" class="form-control" value="<?php echo $mahasiswa->nim?>" disabled>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="password" value="<?php echo $mahasiswa->password?>">
    </div>
    <div class="form-group">
      <label>Jurusan</label>
      <input type="text" class="form-control" name="jurusan" value="<?php echo $mahasiswa->jurusan?>">
    </div>
    <div class="form-group">
      <label>Program Studi</label>
      <input type="text" class="form-control" name="prodi" value="<?php echo $mahasiswa->prodi?>">
    </div>
    <div class="form-group">
      <label>Kode Dosen Pembimbing</label>
      <input type="text" class="form-control" name="kddospem" value="<?php echo $mahasiswa->kddospem?>">
    </div>
