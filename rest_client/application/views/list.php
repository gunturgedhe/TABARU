...
<div class="form-row col-lg-12">
  ...
  <div class="row">
      <div class="col-lg-3">
        ...
        <a class="btn btn-success" href="<?php echo base_url('index.php/dosen/c_dosen') ?>"><i class="fa fa file"></i>Create</a>
            ...
            <thead class="thead-dark">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $m->nmdospem ?></td>
                  <td>
                    <a class="btn btn-warning" href="<?php echo base_url('index.php/dosen/e_dosen/'). $m->kddospem ?>"><i class="fa fa file"></i>Edit</a>
                    <a class="btn btn-danger" href="<?php echo base_url('index.php/dosen/delete/'). $m->kddospem ?>"><i class="fa fa file"></i>Delete</a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
