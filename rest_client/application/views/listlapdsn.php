...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <li><a type="submit" href="<?php echo base_url('index.php/login/logout')?>"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
    </ul>
  </div>
</nav>
<div class="navbar-form">
  <?php echo form_open('search/search')?>
    <input type="text" name="keyword" id="keyword" class="form-control" placeholder="No.Lap / NIM">
                  ...
                  <table width="150%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                      ...
                      <tbody>
                        ...
                        foreach ($laporan as $m){
                          ...
                          <td>$m->tgl_upld</td>
                          <td>$m->file</td>
                            <td>".anchor('laporan/edit/'.$m->no_lap,'Edit')."
                            ".anchor('laporan/delete/'.$m->no_lap,'Delete')."</td>
                          </tr>";                                  }
                        ?>
                      </tbody>
                  </table>
    ...
    <div class = "col-xl-3 col-sm-6 col-md-4">
      <div class = "single-footer-widget footer_2">
        ...
        <div class= "contact_info">
          ...
          <p><span>Email : </span>etupolinema@gmail.com</p>
        </div>
      </div>
    </div>    
  </div>
