    ...
    <img src="<?php echo base_url(); ?>assets/img/logoo.jpg" alt="logoBrand" id="logoBrand" width="70" height="70">
      <ul class="navbar-nav mr-auto">      
        <li class="nav-item active">
          <h1 class="nav-link">Data Laporan</h1>
        </li>
      </ul>
...
<div class="form-row col-lg-12">
  <form>
    <div class="form-row align-items-center">
      <?php echo form_open('search/searchlapadm')?>
        <div class="col-auto"> 
...
<div class="table-responsive">
  ...
  <div class="row">
      <div class="col-lg-3">
        ...
        <a class="btn btn-success" href="<?php echo base_url('index.php/lapmhs/c_laporan') ?>"><i class="fa fa file"></i>Create</a>
            ...
            <thead class="thead-dark">
              ...
              <tbody>
                <?php $count = 0;
                  ...
                  $count = $count + 1; ?>
                <tr>
                  <td><?php echo $l->no_lap ?></td>
                  <td><?php echo $l->judul ?></td>
                  <td><?php echo $l->jnlap ?></td>
                  <td><?php echo $l->nim ?></td>
                  <td><?php echo $l->tgl_upld ?></td>
                  <td><?php echo $l->file ?></td>
                  <td>
                    <a class="btn btn-warning" href="<?php echo base_url('index.php/lapmhs/e_laporan/'). $l->no_lap ?>"><i class="fa fa file"></i>Edit</a>
                    <a class="btn btn-danger" href="<?php echo base_url('index.php/lapmhs/delete/'). $l->no_lap ?>"><i class="fa fa file"></i>Delete</a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
